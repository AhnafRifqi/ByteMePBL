  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            TextField(controller: _nama, decoration: const InputDecoration(labelText: 'Nama Produk')),
            ...
            OutlinedButton.icon(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Pilih file ZIP/PDF (Mock)')));
              }, 
