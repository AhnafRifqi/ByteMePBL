      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (data == null || data.isEmpty) {
            return const Center(child: Text('Tidak ada laporan produk bermasalah.'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return Card(
                ...
                child: ListTile(
                  title: Text(item['produk']['nama_produk'], style: const TextStyle(fontWeight: FontWeight.bold)),
                  subtitle: Text('Dilaporkan oleh: ${item['profiles']['username']}\nAlasan: ${item['catatan']}'),
                  isThreeLine: true,
                  trailing: PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      const PopupMenuItem(value: 'hapus', child: Text('Beri Peringatan & Turunkan Produk', style: TextStyle(color: Colors.red))),
                      const PopupMenuItem(value: 'abaikan', child: Text('Abaikan Laporan')),
                    ],
                  ),
                ),
              );
